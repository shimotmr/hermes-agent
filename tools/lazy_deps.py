...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # CVE-2026-48710/GHSA-82w8-qh3p-5jfq — keep lazy-install in sync with pyproject [web]
        "python-multipart==0.0.30",  # FastAPI UploadFile/Form for streaming uploads (NS-501)
    ),
    ...
    "tool.computer_use": (
        "mcp==1.28.1",
        "starlette==1.3.1",  # CVE-2026-48710/GHSA-82w8-qh3p-5jfq — keep in sync with pyproject [computer-use]
    ),
