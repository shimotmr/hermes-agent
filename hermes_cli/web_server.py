...
def start_server(
    ...
    config = uvicorn.Config(
        ...
        # Trust only the explicitly configured reverse-proxy addresses or
        # networks. This preserves upstream proxy hardening without weakening
        # the native Desktop listener's loopback token boundary.
